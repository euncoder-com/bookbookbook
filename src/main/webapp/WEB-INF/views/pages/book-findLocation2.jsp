            ...
            <div class="col-lg-7">
                <div class="bg-white rounded-4 shadow p-4">
                    <div class="p-4">
                        ...
                        <div class="row g-5">
                            <select class="form-select d-inline-block  border pt-1" style="width: 40%" id="si">
                                <option value="37.5665,126.9780">도/시 (선택)</option>
                            </select>
                            <select class="form-select d-inline-block  border" style="width: 40%" id="gu">
                                <option value="0" selected="" disabled="">시/구 (선택)</option>
