...
public class UserServiceImpl implements UserService{
    ...
    public UserServiceImpl(UserDAO userDAO, BookshelfDAO bookshelfDAO, PasswordEncoder passwordEncoder) {
    ...
    public List<BookshelfVO> readStatus(BookshelfVO vo, HttpSession session) {
        vo.setUserNum((String) session.getAttribute("userNum")); //getAttribute 메소드는 반환 타입이 Object이므로, 이를 String 타입으로 변환하여 BookshelfVO 객체의 userNum 필드에 설정
